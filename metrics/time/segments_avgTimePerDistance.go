...
func GetPace(segment *strava.SegmentDetailed, service *strava.SegmentsService) (float64, float64, float64) {
	...
	difference := avgElapsedPacePerMile - paceTop30 // TODO: use absolute value
	...
	return difficulty, paceTop30, avgElapsedPacePerMile
}
